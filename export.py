...
def card_markdown(node: RepNode, card: RationaleCard, engine_info: Optional[dict]) -> str:
    ...
    out.append("")
    out.append(f"**{card.logic_label}.** {card.opening_logic}")
    out.append("")
...
def to_markdown(
    ...
    out.append("")
    out.append(
        f"_Generated by the Opening Rationale Explorer. "
...
<div class="card">
  ...
  <div class="layout">
    ...
    <div class="body">
      ...
      <div class="section"><b>{html.escape(card.logic_label)}.</b> {html.escape(card.opening_logic)}</div>
...
<p><em>Generated by the Opening Rationale Explorer.
